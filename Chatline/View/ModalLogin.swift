...
class ModalLogin: NSView {
    ...
    @IBAction func createAccountButtonClicked(_ sender: Any) {
        ...
        let createAccoutDict:[String: ModalType] = [USER_INFO_MODAL: ModalType.createAccount]
        NotificationCenter.default.post(name: NOTIF_PRESENT_MODAL, object: nil, userInfo: createAccoutDict)
    }
